...
|---|---|---|
| **Compute** | Virtual machines | AWS EC2, Azure VM, GCP Compute Instance |
| **Containers** | Container tasks, pods, container groups | AWS ECS Task, EKS Pod, Azure Container Instance, GCP Cloud Run |
| **Load Balancers** | Application, network, classic | AWS ALB/NLB/CLB, Azure LB, GCP LB |
| **Managed Databases** | RDS, Aurora, Cloud SQL (public endpoint) | AWS RDS, Azure SQL DB, GCP Cloud SQL |
| **Serverless** | Function endpoints, API gateways | AWS Lambda URL, API Gateway, Azure Function, GCP Cloud Run |
| **Network Services** | NAT gateways, Elastic IPs, public NICs | AWS NAT Gateway, EIP, Azure Public IP, GCP External IP |
| **Kubernetes Services** | NodePort / LoadBalancer-type services | EKS, AKS, GKE services with external IPs |
| **Storage / CDN** | Buckets with public access, distributions | S3, Azure Blob, CloudFront, Azure CDN |
...
| Resource types | 1 (VirtualMachine) | 12+ (VM, Container, LB, NAT, K8s Service, etc.) |
